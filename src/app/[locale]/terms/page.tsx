...
export async function generateMetadata({
  ...
  return {
    title: dict.terms.seo.title,
    description: dict.terms.seo.description,
    keywords: dict.terms.seo.keywords,
  };
}
    ...
    <div className="flex flex-col min-h-screen">
      <div className="bg-brand-700 pt-28 pb-16 md:pt-36">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold text-white">{dict.terms.hero.title}</h1>
          <p className="text-brand-100 mt-4">{dict.terms.hero.lastUpdated}</p>
        </div>
      </div>
